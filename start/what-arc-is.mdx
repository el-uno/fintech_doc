...
It is not a wallet, not a demo app with a `balance` column, and not a toy. The distinction that matters:
...
Stated plainly, because a simulation that hides its seams teaches the wrong things.
