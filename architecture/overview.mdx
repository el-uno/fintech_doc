...
<Steps>
  ...
  <Step title="ESLint no-restricted-imports catches package-name imports">
    ...
    That gap was found by deliberately probing both mechanisms rather than by reading the configuration. It is [a scenario in itself](/stories/the-boundary-that-wasnt), and it is the reason both layers exist.
