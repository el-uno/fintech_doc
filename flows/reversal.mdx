...
**Balance is necessary but not sufficient: an audit trail can be false while the arithmetic is true.** [The full breakdown →](/stories/the-journal-that-balanced-and-lied)
</div>
